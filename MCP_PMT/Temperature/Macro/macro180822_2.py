...
data1 = np.loadtxt("/home/bqt/kojima/MCP_PMT/Data/1808/Temperature180903_1H.csv", delimiter=",", unpack = True, dtype = dtype_data1)
...
graph1.GetYaxis().SetRangeUser(20.,45.)
...
graph2.GetYaxis().SetRangeUser(20.,45.)
