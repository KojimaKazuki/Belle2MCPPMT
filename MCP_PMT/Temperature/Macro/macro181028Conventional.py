...
dataGainListName = "/home/bqt/kojima/MCP_PMT/Data/1810/AnalysisData/JT0695DataListGain.txt"
...
dataTTSListName = "/home/bqt/kojima/MCP_PMT/Data/1810/AnalysisData/JT0695DataListTTS.txt"
...
dataTempListName = "/home/bqt/kojima/MCP_PMT/Data/1810/AnalysisData/JT0695DataListTemp.txt"
...
graph2.SetTitle(";Temperature / degree Celsius; Gain / #times 10^{6}")
...
func2Fit = TF1("func2Fit","pol1",30.,40.)
func2Fit.SetParameter(1, -0.01)
graph2.Fit("func2Fit","","",30.,40.)
...
graph1.Draw("AP")
text1.DrawTextNDC(0.4, 0.84, "JT0695 (Conventional)")
text1_2.DrawTextNDC(0.4, 0.785, "  Normal HV = 3,260 V")

c1.cd(2)
c1.DrawFrame( 25., 0., 45., 2.)
graph2.Draw("AP")
func2.Draw("same")
c1.Update()

#legend.Draw("same")
text2.DrawTextNDC(0.4, 0.84, "JT0695 (Conventional)")
text2_2.DrawTextNDC(0.4, 0.785, "  Normal HV = 3,260 V")
c1.Update()
