void macroHistogram1D_181003(){
    ...
    inTree1 -> Draw("adc_ref >> hist1 ( 100, 0.0, 200.0)", cut1);
    ...
    inTree2 -> Draw("adc_ref >> hist2 ( 100, 0.0, 200.0)", cut1);
    ...
    inTree3 -> Draw("adc_ref >> hist3 ( 100, 0.0, 200.0)", cut1);
    ...
    inTree4 -> Draw("adc_ref >> hist4 ( 100, 0.0, 200.0)", cut1);
    ...
    char Title1[256];
    sprintf(Title1, "ref. MPPC  |  1 Oct. 2018 (KT0552); ADC Count / 0.25 pC ; # of Event",);
    char Title2[256];
    ...
    legend1 -> AddEntry(hist1,"ref.MPPC in 0 T","l"); 
    legend1 -> AddEntry(hist2,"ref.MPPC in 1.5 T","l"); 
    ...
    hist4 -> SetTitle(Title2); 
    ((TGaxis*)hist4->GetYaxis())->SetMaxDigits(4);
    //hist1 -> SetTitle("ref. MPPC  |  1 Oct. 2018; TDC Count / 25 ps ; # of Event"); 
    ...
    legend2 -> AddEntry(hist3,"ref. MPPC in 0 T","l"); 
    legend2 -> AddEntry(hist4,"ref. MPPC in 1.5 T","l"); 
    //legend -> AddEntry(None, "MCP-PMT ID: KT0835;HV = 2,110 V", "");
    ...
    stat3 -> SetY1NDC(0.76-stat_Height);
    stat3 -> SetX2NDC(xTR2);
    stat3 -> SetY2NDC(0.76);
    ...
    stat4 -> SetY1NDC(0.76-2*stat_Height-0.01);
    stat4 -> SetX2NDC(xTR2);
    stat4 -> SetY2NDC(0.76-stat_Height-0.01);
    ...
    //TLegend *legend3 = new TLegend(0.14,0.77,0.39,0.88);
    legend3 -> AddEntry(hist5,"ref. MPPC in 0 T","l"); 
    legend3 -> AddEntry(hist6,"ref. MPPC in 1.5 T","l"); 
    //legend -> AddEntry(None, "MCP-PMT ID: KT0835;HV = 2,110 V", "");
    ...
    hist8 -> SetTitle("ref. MPPC  |  12 Oct. 2018 (KT0689); ADC Count / 0.25 pC ; # of Event"); 
    hist7 -> SetLineColor(kBlue);
    hist8 -> SetLineColor(kRed);


    TLegend *legend4 = new TLegend(0.14,0.77,0.39,0.88);
    //TLegend *legend4 = new TLegend(0.14,0.77,0.39,0.88);
    legend4 -> AddEntry(hist7,"ref. MPPC in 0 T","l"); 
    legend4 -> AddEntry(hist8,"ref. MPPC in 1.5 T","l"); 
    //legend -> AddEntry(None, "MCP-PMT ID: KT0835;HV = 2,110 V", "");
    ...
    stat7 -> SetY1NDC(0.76-stat_Height);
    stat7 -> SetX2NDC(xTR4);
    stat7 -> SetY2NDC(0.76);
    ...
    stat8 -> SetY1NDC(0.76-2*stat_Height-0.01);
    stat8 -> SetX2NDC(xTR4);
    stat8 -> SetY2NDC(0.76-stat_Height-0.01);
