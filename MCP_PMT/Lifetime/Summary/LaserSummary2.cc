...
int main(int argc,char *argv[]){
  ...
  gPad->DrawFrame(0,0,max_charge_rQE,1.2,"Relative QE;Output charge (mC/cm^{2});Relative QE");
  ...
  gPad->DrawFrame(0,0,max_charge,1.2,"Relative QE;Output charge (mC/cm^{2});Relative QE");
  for(j = 0;j < 8;j++){
  ...
  gPad->DrawFrame(0,0,max_charge,3,"Relative Gain;Output charge (mC/cm^{2});Relative Gain");
  for(j = 0;j < 8;j++){
  ...
  cout << endl << endl;
  cout << "Ctrl+C to close Canvas." << endl << endl;
