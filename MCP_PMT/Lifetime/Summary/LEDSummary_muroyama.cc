...
int main(int argc,char *argv[]){
  ...
  //LifetimeAna *lifeana = new LifetimeAna("../config_20171214.txt");//life16
  LifetimeAna *lifeana = new LifetimeAna("../config_20180101.txt");//life17
  ...
  */
  //sprintf(fname,"/home/takt/lifetime/dataset/life%d/dst/led/LED_2_run%d.root",16,Nrun);
  sprintf(fname,"/home/takt/lifetime/dataset/life%d/dst/led/LED_2_run%d.root",17,Nrun);
